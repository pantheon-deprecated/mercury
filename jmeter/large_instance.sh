...
TEST_NAME="mercury_1.0_32" #no spaces please
TEST_FILE="tests/default.jmx"
DRUPAL_HOST="" #for best results, use the AMI's priivate DNS name
...
JMETER_THREADS=10 #default 10
JMETER_LOOPS=10  #default 10
NUM_THREADS=5 #add this number of threads each test - default 10
